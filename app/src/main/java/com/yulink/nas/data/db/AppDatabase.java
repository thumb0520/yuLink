package com.yulink.nas.data.db;
...
import com.yulink.nas.data.db.converter.DateConverter;
import com.yulink.nas.data.db.converter.ProtocolTypeConverter;
import com.yulink.nas.data.db.dao.ConnectionDao;
...
public abstract class AppDatabase extends RoomDatabase {
    private static final String DATABASE_NAME = "yulink_db";
