...
import com.easyconnect.nas.EasyConnectApp;
import com.easyconnect.nas.R;
import com.easyconnect.nas.data.model.TransferTask;
import com.easyconnect.nas.ui.main.MainActivity;
...
public class TransferNotificationHelper {
    ...
    public Notification createProgressNotification(TransferTask task) {
        ...
        return new NotificationCompat.Builder(context, EasyConnectApp.CHANNEL_ID_TRANSFER)
    ...
    public void showCompletionNotification(TransferTask task) {
        ...
        Notification notification = new NotificationCompat.Builder(context, EasyConnectApp.CHANNEL_ID_TRANSFER)
                .setSmallIcon(R.drawable.ic_transfer)
